...
#### **[food-ordering-system](https://github.com/Cortadai/food-ordering-system)** ⭐⭐⭐
...
#### **[poc-01-jooq](https://github.com/Cortadai/poc-01-jooq)** ⭐⭐
...
**Proyecto POC-03-SCK** (En Progreso)
- Construcción de proof-of-concept de Spring Cloud Kubernetes
- Implementación de microservicios de Empleados, Departamentos y Organizaciones
- Enfoque en descubrimiento de servicios, gestión de configuración y circuit breakers
- Siguiendo mejores prácticas de arquitectura empresarial
